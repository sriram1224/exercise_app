...
const Banner = () => {
  return (
    <section className="text-gray-300 body-font bg-gray-800">
      <div className="container px-5 py-24 mx-auto flex flex-wrap">
        <div className="flex w-full mb-20 flex-wrap">
          <h1 className="sm:text-3xl text-2xl font-medium title-font text-900 lg:w-1/3 lg:mb-0 mb-4">Where Fitness Meets Fun and Results Are Achieved</h1>
